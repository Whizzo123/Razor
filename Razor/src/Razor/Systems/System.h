...
namespace Razor
{
	...
	enum class RenderStage { RENDER_STAGE_MATERIAL_PASS, RENDER_STAGE_TEXT_PASS, RENDER_STAGE_LIGHTING_PASS, RENDER_STAGE_TRANSFORMATION_PASS, RENDER_STAGE_CAMERA_PASS, RENDER_STAGE_RENDER };
	#endif
